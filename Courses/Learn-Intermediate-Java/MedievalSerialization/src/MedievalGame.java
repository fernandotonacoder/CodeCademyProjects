...
public class MedievalGame {
        ...
        private Player start(Scanner console) {
            ...
            while(true) {
                ...
                if (answer.equals("y")){
                    ...
                    String introducedName = console.next();
                    while (true) {
                        System.out.println("Welcome " + introducedName + ", am I pronouncing that correctly? (Enter 'y' to confirm, 'n' to enter a new name");
                        ...
                        introducedName = console.next();
                    }
                    player = new Player(introducedName);
                    break;
                } else {
        ...
        private Player load(String playerName, Scanner console) {
            ...
            try{
                ...
                FileInputStream fileInputStream = new FileInputStream(playerName);
